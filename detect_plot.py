...
def detect(source, model, view_img, save_txt, imgsz, trace, modelc, save_img=False, augment = True,
           conf_thres=0.25, iou_thres=0.45, device='cpu', img_size=640):
    save_img = True

    # Directories
    save_dir = plotted_path
...
plotted_path = "/shared/PatoUTN/PAP/Datasets/test_2_step/Effnetb0v2"
...
for image in os.listdir(test_path):
    ...
    detect(source=img_path, model=model, modelc=modelc,view_img=False, imgsz=imgsz, trace=True, augment=True, device=device, save_img=True,
           save_txt=False)