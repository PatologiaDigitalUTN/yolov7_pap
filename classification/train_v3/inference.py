...
# Constants.
DATA_PATH = "E:\\MLPathologyProject\\pap\\CRIC\\muestras\\celulas_clasif_imagen"
IMAGE_SIZE = 224
DEVICE = 'cpu'
# Class names.
class_names = ['Altered', 'Normal']
# Load the trained model.
model = build_model(pretrained=False, fine_tune=False, num_classes=2)
model.load_state_dict(torch.load("E:\\MLPathologyProject\\pap\\CRIC\\result\\" \
    "clasificacion_efficientnetb0_2_clases\\model.pt", map_location=DEVICE))
